...
<body>
    ...
    <main class="d-flex flex-wrap">
        <div class="left col-12 col-lg-5 col-md-6">
            ...
            <p>Lorem ipsum dolor sit amet consectetur. Non iaculis sodales habitasse dignissim. Urna commodo a massa
                aliquam. </p>
    ...
    <article class="d-flex flex-wrap">
        <div class="art-left col-12 col-lg-6 col-md-6">
            <h5 style="color: #01a6dd;">What We Give</h5>
            <h2>Best Feature For You</h2>
            <p>Lorem ipsum dolor sit amet consectetur. Non iaculis sodales habitasse dignissim. Urna commodo a massa
                aliquam. </p>
        </div>
        ...
        <div class="art-right col-12 col-lg-6 col-md-6 ">
            <div class="art-one ">
                <div>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur. Non iaculis sodales habitasse dignissim. Urna commodo a
                        massa aliquam. </p>
                </div>
    ...
    <article class="article-two">
        ...
        <P class="text-center">Lorem ipsum dolor sit amet consectetur. Non iaculis sodales habitasse dignissim. Urna
            commodo a massa aliquam. </P>
    </article>
        ...
        <div class="art-three-left col-12 col-lg-6 col-md-6">
            ...
            <div class="profile">
                <div class="pro-flex d-flex flex-wrap">
                    ...
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Modi dolores autem odio animi aperiam
                        illo laboriosam perspiciatis incidunt optio? Reiciendis optio molestiae, assumenda saepe nemo
                        nesciunt dolor consequatur modi hic?</p>
                </div>
            </div>
        </div>
